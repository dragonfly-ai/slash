...
class Gaussian extends OnlineProbabilityDistributionEstimator[Double, distributions.Gaussian]  {

  val estimator: PointStatisticsEstimator[Double] = new PointStatisticsEstimator[Double](distributions.Gaussian.domain)

  override def apply(frequency: Double, observation: Double): OnlineProbabilityDistributionEstimator[Double, distributions.Gaussian] = {
