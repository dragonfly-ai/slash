...
- Parametric and Estimated (Online/Streaming) Probability Distributions: Gaussian/Normal, Poisson, LogNormal, and Beta; each with support for sampling and probability density functions, PDFs.
...
libraryDependencies += "ai.dragonfly.code" %%% "vector" % "0.33"
</pre><br />
