...
package object vector {
  ...
  trait VectorOps[V] {
    extension (v: V) def scale(scalar: Double): Vector
    extension (v: V) def divide(divisor: Double): Vector
    extension (v: V) def *(scalar: Double): Vector
    extension (v: V) def /(divisor: Double): Vector
    extension (v: V) def add(v1: V): Vector
    extension (v: V) def subtract(v1: V): Vector
    extension (v: V) def +(v1: V): Vector
    extension (v: V) def -(v1: V): Vector
    extension (v: V) def normalize: Vector
    extension (v: V) def dot(v1: V): Double
    extension (v: V) def distanceSquaredTo(v1:V): Double
    extension (v: V) def distanceTo(v1:V): Double

  }

  import ai.dragonfly.math.vector.*

  given VectorOps[Vector] with {
